...
const dummy = {
  Restaurant: {
    address: "Jakarta",
    description:
      "Restoran ini menawarkan pengalaman kuliner yang unik dengan menu yang inovatif dan cita rasa yang luar biasa.",
    imgUrl:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/14/39/b2/74/pasola-restaurant-buffet.jpg?w=1200&h=-1&s=1",
